...
public class RubyController : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        {
            RaycastHit2D hit = Physics2D.Raycast(rigidbody2D.position , lookDirection, 1.5f, LayerMask.GetMask("NPC"));
            if(hit.collider != null)
            {
                Debug.Log("You HIT Frog");
    ...
    public void HealthCacluator(int number)
    {
        ...
        UIManager.Instance.ShowHealth(currentHealth / maxhealth);
